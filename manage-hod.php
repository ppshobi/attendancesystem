...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['deleteteacher'])) {
	...
	$result=HOD::delete($_POST['teacherid']);
	if ($result) {
		$message=true;
	}else{
		$message=false;
...
<head lang="en">
	...
	<title>Manage Head of The Departments</title>
						...
						if($teachers){
							...
							foreach ($teachers as $teacher) {
								...
								echo "<tr>";
									...
									echo "<td>" . "<a href=\"edit-hod.php?id=".$teacher['id']."\" class=\"btn btn-rounded btn-inline btn-warning\" >"."Edit</a></td>";
