			...
			<div class="box-typical box-typical-padding">
				...
				<form method="post" id="student" action="">
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<p class="form-control-static"><input id="name" type="text" name="name" class="form-control" placeholder="Student Name"></p>
						</div>
					</div>
					<div class="form-group row">
						<label for="TeacherName" class="col-sm-2 form-control-label">Register No</label>
						<div class="col-sm-10">
							<p class="form-control-static"><input id="regno" type="text" name="regno" class="form-control" placeholder="Register No"></p>
						</div>
					</div>
					<div class="form-group row">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<button type="submit" name="add-stud" class="btn btn-inline btn-success-outline swal-btn-success">Create Student</button>
						</div>
					</div>
