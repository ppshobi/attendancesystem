			...
			<div class="box-typical box-typical-padding">
				...
				<form method="post" action="">
					<div class="form-group row">
						<label for="DepartmentName" class="col-sm-2 form-control-label">Semester Start Date</label>
						<div class="col-sm-4">
					...
					<div class="form-group row">
						<label for="DepartmentName" class="col-sm-2 form-control-label">Semester End Date</label>
						<div class="col-sm-4">
