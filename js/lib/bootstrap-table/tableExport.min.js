...
(2-1.15)/2*a.row.styles.fontSize*(d-2)/3);return!0}return!1}function J(b,a,d){return b.replace(new RegExp(a.replace(/([.*+?^=!:${}()|\[\]\/\\])/g,"\\$1"),"g"),d)}function V(b){b=J(b||"0",a.numbers.php.decimalMark,".");b=J(b,a.numbers.php.thousandsSeparator,"");return"number"===typeof b||!1!==jQuery.isNumeric(b)?b:!1}function v(b,u,d){var e="";if(null!=b){b=c(b);var k=b.php();"function"===typeof a.onCellHtmlData&&(k=a.onCellHtmlData(b,u,d,k));if(!0===a.phpContent)e=c.trim(k);else{var f=k.replace(/\n/g,
"\u2028").replace(/<br\s*[\/]?>/gi,"\u2060"),k=c("<div/>").php(f).contents(),f="";c.each(k.text().split("\u2028"),function(b,a){0<b&&(f+=" ");f+=c.trim(a)});c.each(f.split("\u2060"),function(b,a){0<b&&(e+="\n");e+=c.trim(a).replace(/\u00AD/g,"")});if(a.numbers.php.decimalMark!=a.numbers.output.decimalMark||a.numbers.php.thousandsSeparator!=a.numbers.output.thousandsSeparator)if(k=V(e),!1!==k){var g=(""+k).split(".");1==g.length&&(g[1]="");var h=3<g[0].length?g[0].length%3:0,e=(0>k?"-":"")+(a.numbers.output.thousandsSeparator?
