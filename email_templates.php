		...
		<div class="container-fluid">
				...
				<div class="col-lg-6">
					<section class="card">
						<header class="card-header">
							<a href="mail/confirm-1.php" class="btn btn-primary" target="_blank">View Template</a>
						</header>
						<div class="card-block">
							<img src="img/email_template_1.png" class="img-fluid">
						</div>
					</section>
				</div>
				<div class="col-lg-6">
					<section class="card">
						<header class="card-header">
							<a href="mail/confirm-2.php" class="btn btn-primary" target="_blank">View Template</a>
						</header>
						<div class="card-block">
							<img src="img/email_template_2.png" class="img-fluid">
						</div>
					</section>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-6">
					<section class="card">
						<header class="card-header">
							<a href="mail/confirm-3.php" class="btn btn-primary" target="_blank">View Template</a>
						</header>
						<div class="card-block">
							<img src="img/email_template_3.png" class="img-fluid">
						</div>
					</section>
				</div>
				<div class="col-lg-6">
					<section class="card">
						<header class="card-header">
							<a href="mail/confirm-4.php" class="btn btn-primary" target="_blank">View Template</a>
						</header>
						<div class="card-block">
							<img src="img/email_template_4.png" class="img-fluid">
						</div>
					</section>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-6">
					<section class="card">
						<header class="card-header">
							<a href="mail/confirm-5.php" class="btn btn-primary" target="_blank">View Template</a>
						</header>
						<div class="card-block">
							<img src="img/email_template_5.png" class="img-fluid">
						</div>
					</section>
				</div>
				<div class="col-lg-6">
					<section class="card">
						<header class="card-header">
							<a href="mail/confirm-6.php" class="btn btn-primary" target="_blank">View Template</a>
						</header>
						<div class="card-block">
							<img src="img/email_template_6.png" class="img-fluid">
						</div>
					</section>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-6">
					<section class="card">
						<header class="card-header">
							<a href="mail/confirm-7.php" class="btn btn-primary" target="_blank">View Template</a>
						</header>
						<div class="card-block">
							<img src="img/email_template_7.png" class="img-fluid">
						</div>
					</section>
				</div>
			</div>
