			...
			<div class="box-typical box-typical-padding">
				...
				<form method="post" action="">
					<div class="form-group row">
						<label class="col-sm-2 form-control-label">Department Name</label>
						<div class="col-sm-10">
					...
					<div class="form-group row">
						<label for="exampleSelect" class="col-sm-2 form-control-label">Department Description</label>
						<div class="col-sm-10">
							<textarea rows="4" class="form-control" placeholder="Textarea"></textarea>
						</div>
					</div>
					<button type="submit" class="btn btn-inline btn-success-outline">Add Department</button>
				</form>
