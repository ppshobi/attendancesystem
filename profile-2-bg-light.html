...
<body>
	...
	<div class="page-content">
		<div class="profile-header-photo opacity" style="background-image: url(img/profile-bg-light.jpg)">
			...
			<div class="row">
				<div class="col-xl-3 col-lg-4">
					<aside class="profile-side">
						...
						<section class="box-typical">
							<header class="box-typical-header-sm bordered">Recomendation</header>
							<div class="box-typical-inner">
								<p>All stream</p>
								<p>Connected Apps</p>
								<p>Photos</p>
