		...
		<div class="container-fluid">
			...
			<section class="box-typical box-typical-padding">
				<div class="row">
					...
					<div class="col-md-6">
						<div class="dd dd-green" id="nestable2">
							<ol class="dd-list">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="dd dd-purple" id="nestable3">
							<ol class="dd-list">
								<li class="dd-item" data-id="1">
									<div class="dd-handle">Item 1</div>
								</li>
					...
					<div class="col-md-6">
						<div class="dd dd-grey" id="nestable4">
							<ol class="dd-list">
								<li class="dd-item" data-id="13">
									<div class="dd-handle">Item 13</div>
								</li>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="dd dd-aquamarine" id="nestable5">
							<ol class="dd-list">
								<li class="dd-item" data-id="1">
									<div class="dd-handle">Item 1</div>
								</li>
					...
					<div class="col-md-6">
						<div class="dd dd-red" id="nestable6">
							<ol class="dd-list">
								<li class="dd-item" data-id="13">
									<div class="dd-handle">Item 13</div>
								</li>
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="dd dd3-blue" id="nestable8">
							<ol class="dd-list">
								<li class="dd-item dd3-item" data-id="13">
									<div class="dd-handle dd3-handle">Drag</div><div class="dd3-content">Item 13</div>
								</li>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="dd dd3-orange" id="nestable9">
							<ol class="dd-list">
								<li class="dd-item dd3-item" data-id="13">
									<div class="dd-handle dd3-handle">Drag</div><div class="dd3-content">Item 13</div>
								</li>
