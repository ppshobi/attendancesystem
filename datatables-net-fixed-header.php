		...
		<ul class="side-menu-addl-list">
			...
			<li>
				<a href="datatables-net-col-reorder.php">
					<span class="tbl-row">
						<span class="tbl-cell tbl-cell-caption">Col Reorder</span>
					</span>
				</a>
			</li>
			<li>
			...
			<li>
				<a href="datatables-net-fixed-header.php">
					<span class="tbl-row">
						<span class="tbl-cell tbl-cell-caption">Fixed Header</span>
					</span>
				</a>
			</li>
			<li>
			...
			<li>
				<a href="datatables-net-row-reorder.php">
					<span class="tbl-row">
						<span class="tbl-cell tbl-cell-caption">Row Reorder</span>
					</span>
				</a>
			</li>
		</ul>
