            ...
            <div class="box-typical box-typical-padding">
                <div class="row">
                    <div class="col-xl-6">
                        <div class="row">
                            <div class="col-sm-12">
                                <form class="box-typical box-typical-upload scrollable-block scrollable-gradient">
                        ...
                        <div class="col-sm-12">
                            <section class="card">
                                <header class="card-header">
                                    Popup upload with left menu
                                </header>
                                <div class="card-block text-center">
                                    <a href="#" data-toggle="modal" data-target="#uploadModal" class="btn btn-primary">Click to show upload modal window</a>
                                </div>
                            </section>
                        </div><!--.col-->
                    </div><!--.row-->
                ...
                <div class="col-xl-6">
                    <div class="row">
                        <div class="col-sm-12">
                            <section class="card">
                                <header class="card-header">
                                    Popup upload with bottom menu
                                </header>
                                <div class="card-block text-center">
                                    <a href="#" data-toggle="modal" data-target="#upload2Modal" class="btn btn-primary">Click to show upload modal window</a>
                                </div>
                            </section>
                        </div><!--.col-->
                    </div><!--.row-->
                ...
                <div class="col-xl-6">
                    <div class="row">
                        <div class="col-sm-12">
                            <section class="card">
                                <header class="card-header">
                                    Popup upload with left tabbed menu
                                </header>
                                <div class="card-block text-center">
                                    <a href="#" data-toggle="modal" data-target="#upload3Modal" class="btn btn-primary">Click to show upload modal window</a>
                                </div>
                            </section>
                        </div><!--.col-->
                    </div><!--.row-->
