...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['editteacher'])) {
	...
	$result=HOD::edit($_POST['teacherid'],$_POST['name'],$_POST['dept']);
	if ($result) {
		$message=true;
	}else{
		$message=false;
			...
			<div class="box-typical box-typical-padding">
				...
				<form method="post" action="">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<button type="submit" name="editteacher" class="btn btn-inline btn-success-outline swal-btn-success">Update HOD</button>
						</div>
					</div>
