	        ...
	        <div class="row">
	            <div class="col-sm-6">
	                <ul style="font-size: 1rem">
	                    <li><a href="side-menu-full.php">side-menu-full.php</a></li>
	                    <li><a href="side-menu-big-icon.php">side-menu-big-icon.php</a></li>
	                    <li><a href="side-menu-avatar.php">side-menu-avatar.php</a></li>
	                    <li><a href="side-menu-compact.php">side-menu-compact.php</a></li>
	                    <li><a href="side-menu-compact-full.php">side-menu-compact-full.php</a></li>
	                    <li><a href="side-menu-compact-divider.php">side-menu-compact-divider.php</a></li>
	                    <li><a href="side-menu-compact-avatar.php">side-menu-compact-avatar.php</a></li>
	                    <li><a href="side-menu-compact-addl.php">side-menu-compact-addl.php</a></li>
	                    <li><a href="side-menu-addl.php">side-menu-addl.php</a></li>
	                    <li>&nbsp;</li>
	                    <li><a href="dashboard.php">dashboard.php</a></li>
	                    <li><a href="dashboard-compact-menu.php">dashboard-compact-menu.php</a></li>
	                    <li><a href="dashboard-addl-menu.php">dashboard-addl-menu.php</a></li>
	                    <li>&nbsp;</li>
	                    <li><a href="ui-checkboxes.php">ui-checkboxes.php</a></li>
	                    <li><a href="ui-buttons.php">ui-buttons.php</a></li>
	                    <li><a href="ui-form.php">ui-form.php</a></li>
	                    <li><a href="ui-form-validation.php">ui-form-validation.php</a></li>
	                    <li><a href="ui-form-extras.php">ui-form-extras.php</a></li>
	                    <li><a href="ui-select.php">ui-select.php</a></li>
	                    <li><a href="ui-datepicker.php">ui-datepicker.php</a></li>
	                    <li><a href="tables.php">tables.php</a></li>
	                    <li><a href="datatables.php">datatables.php</a></li>
	                    <li>&nbsp;</li>
	                    <li><a href="typography.php">typography.php</a></li>
	                    <li><a href="elements.php">elements.php</a></li>
	                    <li><a href="contacts.php">contacts.php</a></li>
	                    <li><a href="activity.php">activity.php</a></li>
	                    <li><a href="tabs.php">tabs.php</a></li>
	                    <li>&nbsp;</li>
	                    <li><a href="sign-in.php">sign-in.php</a></li>
	                    <li><a href="sign-up.php">sign-up.php</a></li>
	                    <li>&nbsp;</li>
	                    <li><a href="faq.php">faq.php</a></li>
	                    <li><a href="documentation.php">documentation.php</a></li>
	                    <li><a href="empty.php">empty.php</a></li>
	                    <li>&nbsp;</li>
	                    <li><a href="prices.php">prices.php</a></li>
	                    <li><a href="panels.php">panels.php</a></li>
	                    <li><a href="range-slider.php">range-slider.php</a></li>
	                    <li><a href="gallery.php">gallery.php</a></li>
	                    <li><a href="editor.php">editor.php</a></li>
	                    <li><a href="contacts-page.php">contacts-page.php</a></li>
	                    <li><a href="files.php">files.php</a></li>
	                    <li><a href="mail.php">mail.php</a></li>
	                    <li><a href="list-tasks.php">list-tasks.php</a></li>
	                    <li>&nbsp;</li>
	                    <li><a href="profile-2.php">profile-2.php</a></li>
	                    <li><a href="profile-2-bg.php">profile-2-bg.php</a></li>
	                    <li><a href="profile-2-bg-light.php">profile-2-bg-light.php</a></li>
	                    <li><a href="helpers.php">helpers.php</a></li>
	                </ul>
	            </div>
	            <div class="col-sm-6">
	                <ul style="font-size: 1rem">
	                    <li><a href="profile.php">profile.php</a></li>
	                    <li><a href="profile-edit.php">profile-edit.php</a></li>
	                    <li><a href="scheduler.php">scheduler.php</a></li>
	                    <li><a href="avatars.php">avatars.php</a></li>
	                    <li>&nbsp;</li>
	                    <li><a href="chat.php">chat.php</a></li>
	                    <li><a href="chat-write.php">chat-write.php</a></li>
	                    <li><a href="chat-index.php">chat-index.php</a></li>
	                    <li>&nbsp;</li>
	                    <li><a href="#" class="swal-btn-basic">alert basic</a></li>
	                    <li><a href="#" class="swal-btn-text">alert text</a></li>
	                    <li><a href="#" class="swal-btn-success">alert success</a></li>
	                    <li><a href="#" class="swal-btn-warning">alert warning</a></li>
	                    <li><a href="#" class="swal-btn-cancel">alert cancel</a></li>
	                    <li><a href="#" class="swal-btn-info">alert info</a></li>
	                    <li><a href="#" class="swal-btn-custom-img">alert custom image</a></li>
	                    <li>&nbsp;</li>
	                    <li><a href="upload-dashboard.php">upload-dashboard.php</a></li>
	                    <li><a href="#" data-toggle="modal" data-target="#uploadModal">popup upload</a></li>
	                    <li><a href="#" data-toggle="modal" data-target="#upload2Modal">popup upload bottom menu</a></li>
	                    <li>&nbsp;</li>
	                    <li><a href="error-404.php">error-404.php</a></li>
	                    <li><a href="error-500.php">error-500.php</a></li>
	                    <li>&nbsp;</li>
	                    <li><a href="notice-notie.js.php">notice-notie.js.php</a></li>
	                    <li><a href="notice-bootstrap-notify.php">notice-bootstrap-notify.php</a></li>
	                    <li><a href="notice-pnotify.php">notice-pnotify.php</a></li>
	                    <li>&nbsp;</li>
	                    <li><a href="dark-menu.php">dark-menu.php</a></li>
	                    <li><a href="dark-menu-blue.php">dark-menu-blue.php</a></li>
	                    <li><a href="dark-menu-green.php">dark-menu-green.php</a></li>
	                    <li><a href="dark-menu-green-compact.php">dark-menu-green-compact.php</a></li>
	                    <li><a href="dark-menu-ultramarine.php">dark-menu-ultramarine.php</a></li>
	                    <li><a href="asphalt-menu.php">asphalt-menu.php</a></li>
	                    <li><a href="light-menu.php">light-menu.php</a></li>
	                    <li>&nbsp;</li>
	                    <li><a href="nestable.php">nestable.php</a></li>
	                    <li><a href="range-slider-2.php">range-slider-2.php</a></li>
	                    <li><a href="alerts.php">alerts.php</a></li>
	                    <li><a href="player.php">player.php</a></li>
	                    <li><a href="faq-search.php">faq-search.php</a></li>
	                    <li><a href="steps.php">steps.php</a></li>
	                    <li><a href="widgets.php">widgets.php</a></li>
	                    <li><a href="cards.php">cards.php</a></li>
	                    <li><a href="project.php">project.php</a></li>
	                    <li><a href="#" data-toggle="modal" data-target="#upload3Modal">popup upload big icons</a></li>
	                    <li>&nbsp;</li>
	                    <li><a href="theme-side-ebony-clay.php">theme-side-ebony-clay.php</a></li>
	                    <li><a href="theme-side-madison-caribbean.php">theme-side-madison-caribbean.php</a></li>
	                    <li><a href="theme-side-caesium-dark-caribbean.php">theme-side-caesium-dark-caribbean.php</a></li>
	                    <li><a href="theme-side-tin.php">theme-side-tin.php</a></li>
	                    <li><a href="theme-side-litmus-blue.php">theme-side-litmus-blue.php</a></li>
	                    <li><a href="theme-rebecca-purple.php">theme-rebecca-purple.php</a></li>
	                    <li><a href="theme-picton-blue.php">theme-picton-blue.php</a></li>
	                    <li><a href="theme-picton-blue-white-ebony.php">theme-picton-blue-white-ebony.php</a></li>
	                </ul>
	            </div>
	        </div>
	        <br/>
	                ...
	                <div class="modal-upload-cont">
	                    <div class="modal-upload-cont-in">
	                        <div class="tab-content">
	                            ...
	                            <div role="tabpanel" class="tab-pane" id="tab-upload-3-2">
	                                Content 2
	                            </div><!--.tab-pane-->
	                            <div role="tabpanel" class="tab-pane" id="tab-upload-3-3">
	                                Content 3
	                            </div><!--.tab-pane-->
	                            <div role="tabpanel" class="tab-pane" id="tab-upload-3-4">
	                                Yandex Disk
	                            </div><!--.tab-pane-->
	                            <div role="tabpanel" class="tab-pane" id="tab-upload-3-5">
	                                Box
	                            </div><!--.tab-pane-->
	                            <div role="tabpanel" class="tab-pane" id="tab-upload-3-6">
	                                One drive
	                            </div><!--.tab-pane-->
	                        </div><!--.tab-content-->
	                    </div><!--.modal-upload-cont-in-->
	                    ...
	                    <ul class="upload-list" role="tablist">
	                        <li class="nav-item">
	                            <a href="#tab-upload-3-1" role="tab" data-toggle="tab" class="active">
	                                <i class="font-icon font-icon-comp"></i>
	                            </a>
	                        </li>
	                        <li class="nav-item">
	                            <a href="#tab-upload-3-2" role="tab" data-toggle="tab">
	                                <i class="font-icon font-icon-link"></i>
	                            </a>
	                        </li>
	                        <li class="nav-item">
	                            <a href="#tab-upload-3-3" role="tab" data-toggle="tab">
	                                <i class="font-icon font-icon-fb-fill"></i>
	                            </a>
	                        </li>
	                        <li class="nav-item">
	                            <a href="#tab-upload-3-4" role="tab" data-toggle="tab">
	                                <i class="font-icon font-icon-dropbox"></i>
	                            </a>
	                        </li>
	                        <li class="nav-item">
	                            <a href="#tab-upload-3-5" role="tab" data-toggle="tab">
	                                <i class="font-icon font-icon-google-drive"></i>
	                            </a>
	                        </li>
	                        <li class="nav-item">
	                            <a href="#tab-upload-3-6" role="tab" data-toggle="tab">
