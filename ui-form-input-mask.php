			...
			<section class="card box-typical-full-height">
				<div class="card-block">
					<div class="row">
						...
						<div class="col-lg-4">
							<fieldset class="form-group">
								...
								<input type="email" class="form-control" id="time-mask-input">
					...
					<div class="row">
						...
						<div class="col-lg-4">
							<fieldset class="form-group">
								...
								<input type="email" class="form-control" id="zip-code-mask-input">
					...
					<div class="row">
						...
						<div class="col-lg-4">
							<fieldset class="form-group">
								...
								<input type="email" class="form-control" id="phone-mask-input">
					...
					<div class="row">
						<div class="col-lg-4">
							<fieldset class="form-group">
								<label class="form-label" for="phone-with-code-area-mask-input">Phone with Code Area</label>
						...
						<div class="col-lg-4">
							<fieldset class="form-group">
								...
								<input type="email" class="form-control" id="us-phone-mask-input">
					...
					<div class="row">
						...
						<div class="col-lg-4">
							<fieldset class="form-group">
								...
								<input type="email" class="form-control" id="mixed-mask-input">
