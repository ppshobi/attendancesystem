		...
		<div class="container-fluid">
			<header class="section-header">
				<div class="tbl">
					<div class="tbl-row">
						<div class="tbl-cell">
							<h3>Generate a Student Wise Report</h3>
			...
			<div class="box-typical box-typical-padding">
				...
				<form method="post" id="student" action="view-report-student.php">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<button type="submit" name="gen-stud-report" class="btn btn-inline btn-success-outline swal-btn-success">Generate Report</button>
						</div>
					</div>
