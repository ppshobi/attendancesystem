	...
	<div class="page-content">
		<div class="container-fluid">
			<section class="box-typical box-typical-padding">
				<h3 class="with-border">ion.rangeSlider</h3>
				<div class="row">
					<div class="col-md-6">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group range-slider-red">
							<input type="text" id="range-slider-5" name="example_name" value="" />
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group range-slider-purple">
							<input type="text" id="range-slider-6" name="example_name" value="" />
						</div>
					</div>
				</div>
			</section>
			...
			<section class="box-typical box-typical-padding">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group range-slider-simple">
							<input type="text" id="range-slider-7" name="example_name" value="" />
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group range-slider-simple range-slider-aquamarine">
							<input type="text" id="range-slider-8" name="example_name" value="" />
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-6">
						<div class="form-group range-slider-simple range-slider-purple">
							<input type="text" id="range-slider-9" name="example_name" value="" />
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group range-slider-simple range-slider-red">
							<input type="text" id="range-slider-10" name="example_name" value="" />
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-6">
						<div class="form-group range-slider-simple range-slider-grey">
							<input type="text" id="range-slider-11" name="example_name" value="" />
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group range-slider-simple range-slider-orange">
							<input type="text" id="range-slider-12" name="example_name" value="" />
						</div>
					</div>
				</div>
			</section>
