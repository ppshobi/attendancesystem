	            ...
	            <div class="site-header-content-in">
	                    ...
	                    <div class="dropdown dropdown-lang">
	                        ...
	                        <div class="dropdown-menu dropdown-menu-right">
	                            <div class="dropdown-menu-col">
	                                <a class="dropdown-item current" href="#"><span class="flag-icon flag-icon-ru"></span>Русский</a>
	                            ...
	                            <div class="dropdown-menu-col">
	                                ...
	                                <a class="dropdown-item" href="#"><span class="flag-icon flag-icon-be"></span>Беларускi</a>
	                ...
	                <div class="site-header-collapsed">
	                    <div class="site-header-collapsed-in">
	                        ...
	                        <div class="dropdown dropdown-typical">
	                            <a class="dropdown-toggle" id="dd-header-projects" data-target="#" href="http://example.com" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
